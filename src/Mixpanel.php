...
use Mixpanel\Base\Base;
use Mixpanel\Producers\EventsProducer;
use Mixpanel\Producers\GroupsProducer;
...
class Mixpanel extends Base {
    ...
    /**
     * An instance of the People class (used to create/update profiles)
     * @var PeopleProducer
     */
    public $people;
    ...
    /**
     * An instance of the Events class
     * @var EventsProducer
     */
    private $_events;

    /**
     * An instance of the Groups class (used to create/update group profiles)
     * @var GroupsProducer
     */
    public $group;
    ...
    public function __construct($token, $options = array()) {
        ...
        $this->people = new PeopleProducer($token, $options);
        $this->_events = new EventsProducer($token, $options);
        $this->group = new GroupsProducer($token, $options);
    }
